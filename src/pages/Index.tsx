        ...
        <>
            <div className="lg:bg-geometry flex justify-center text-center lg:text-start items-start mt-20 sm:mt-0 sm:items-center h-full sm:h-screen lg:flex-col lg:pl-72 lg:pb-16">
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-xl font-bold">Universität Potsdam (Campus III - Griebnitzsee)</p>
                    <p className="text-xl font-bold">16. September 2025</p>
                    <p className="text-xl leading-relaxed lg:w-1/2 px-12 text-justify lg:text-start lg:p-0">
                    Dein Workshop auf dem Informatik Festival 2025: IT-Security am Puls der Zeit. Für junge Menschen – mit Top-Speakern aus Wirtschaft, Politik und Wissenschaft.
                    </p>
